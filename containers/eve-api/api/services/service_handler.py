...
from api.services.user_pregnancy_days_service import UserPregnancyDaysService
...
class ServiceHandler():
    ...
    def register_services():
        ...
        services[ROUTE_CONFIG['USER_PREGNANCY_DAYS_TYPE_NAME']] = UserPregnancyDaysService()
